...
function footerLinks() {
    return (_jsxs("div", __assign({ className: 'flex flex-row gap-4 text-link font-link' }, { children: [_jsx("div", __assign({ className: ' text-primary underline' }, { children: _jsx("a", __assign({ href: 'https://d3iwebserver-webapp-serve-privacy-support-page.azurewebsites.net/static/privacy.html', target: '_blank', rel: 'noreferrer' }, { children: "Privacy" })) })), _jsx("div", { className: 'bg-grey3 w-1px' }), _jsx("div", __assign({ className: ' text-primary underline' }, { children: _jsx("a", __assign({ href: 'https://d3iwebserver-webapp-serve-privacy-support-page.azurewebsites.net/static/support.html', target: '_blank', rel: 'noreferrer' }, { children: "Support" })) }))] })));
}
